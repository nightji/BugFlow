...
$jsd('/BugFlow/src/index.htmlx',14,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});var user; 
$jsd('/BugFlow/src/index.htmlx',15,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); Emp.page.setBackgroundColor("#eaeaea"); 
$jsd('/BugFlow/src/index.htmlx',16,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); Emp.page.addEvent("onLoad", function () { 
$jsd('/BugFlow/src/index.htmlx',17,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); login(); 
}); 
$jsd('/BugFlow/src/index.htmlx',20,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function login() { 
$jsd('/BugFlow/src/index.htmlx',21,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var pref = new $M.Preferences(); 
$jsd('/BugFlow/src/index.htmlx',22,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); pref.open("myPref"); 
$jsd('/BugFlow/src/index.htmlx',23,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var userid = pref.get("userid"); 
$jsd('/BugFlow/src/index.htmlx',24,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var password = pref.get("password"); 
$jsd('/BugFlow/src/index.htmlx',27,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); user = chackUser(userid, password); 
$jsd('/BugFlow/src/index.htmlx',28,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("index,userid", userid); 
$jsd('/BugFlow/src/index.htmlx',29,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("index,password", password); 
$jsd('/BugFlow/src/index.htmlx',32,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); logoDiv.clearAnimation(); 
$jsd('/BugFlow/src/index.htmlx',33,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var alphaAnimation = new $M.AlphaAnimation({fromAlpha:0, toAlpha:1, duration:1500}); 
$jsd('/BugFlow/src/index.htmlx',38,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); logoDiv.addAnimation(alphaAnimation); 
$jsd('/BugFlow/src/index.htmlx',40,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); setTimeout(function () { 
$jsd('/BugFlow/src/index.htmlx',41,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); logoDiv.startAnimation(); 
}, 20); 
$jsd('/BugFlow/src/index.htmlx',45,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); alphaAnimation.addEvent("onAnimationEnd", function () { 
$jsd('/BugFlow/src/index.htmlx',48,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); user = ("wrong"); 
if($jsd('/BugFlow/src/index.htmlx',49,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);})||true) if (user == "wrong") { 
$jsd('/BugFlow/src/index.htmlx',50,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); $M.page.goTo({"url":"/login.html", "isDestroySelf":true, }); 
} else { 
$jsd('/BugFlow/src/index.htmlx',56,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var data = "a"; 
$jsd('/BugFlow/src/index.htmlx',57,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); $M.page.goTo({"url":"/choosepage.html", "params":data, "isDestroySelf":true, }); 
} 
}); 
} 
$jsd('/BugFlow/src/index.htmlx',67,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function chackUser(userid, password) { 
$jsd('/BugFlow/src/index.htmlx',68,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var ajax = new $M.Ajax(); 
$jsd('/BugFlow/src/index.htmlx',69,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("userid", userid); 
$jsd('/BugFlow/src/index.htmlx',70,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("password", password); 
$jsd('/BugFlow/src/index.htmlx',71,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.setAction("/ChackUser.jsp"); 
$jsd('/BugFlow/src/index.htmlx',72,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.submit(function (result) { 
$jsd('/BugFlow/src/index.htmlx',73,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); $M.page.goTo({"url":"/newFlow.html", "isDestroySelf":false, }); 
$jsd('/BugFlow/src/index.htmlx',78,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); user = result; 
}, function (errorCode, errorMsg) { 
$jsd('/BugFlow/src/index.htmlx',81,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("ajax Error : " + errorCode + " " + errorMsg); 
}); 
} 
