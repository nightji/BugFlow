...
$jsd('/BugFlow/src/login.htmlx',32,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var pref = new $M.Preferences(); 
$jsd('/BugFlow/src/login.htmlx',33,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); pref.open("myPref"); 
$jsd('/BugFlow/src/login.htmlx',34,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var userid = EMPuserid.getValue(); 
$jsd('/BugFlow/src/login.htmlx',35,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var password = EMPpassword.getValue(); 
$jsd('/BugFlow/src/login.htmlx',36,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("login,EMPuserid", userid); 
$jsd('/BugFlow/src/login.htmlx',37,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("login,EMPpassword", password); 
$jsd('/BugFlow/src/login.htmlx',38,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var user = chackUser(userid, password); 
if($jsd('/BugFlow/src/login.htmlx',40,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);})||true) if (user.user == "wrong") { 
$jsd('/BugFlow/src/login.htmlx',41,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); alert("wrong"); 
} else { 
$jsd('/BugFlow/src/login.htmlx',44,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); pref.put("userid", userid); 
$jsd('/BugFlow/src/login.htmlx',45,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); pref.put("password", password); 
} 
} 
$jsd('/BugFlow/src/login.htmlx',54,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function cancel() { 
$jsd('/BugFlow/src/login.htmlx',55,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); EMPuserid.setValue(""); 
$jsd('/BugFlow/src/login.htmlx',56,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); EMPpassword.setValue(""); 
} 
$jsd('/BugFlow/src/login.htmlx',59,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function chackUser(userid, password) { 
$jsd('/BugFlow/src/login.htmlx',60,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var ajax = new $M.Ajax(); 
$jsd('/BugFlow/src/login.htmlx',61,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("userid", userid); 
$jsd('/BugFlow/src/login.htmlx',62,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("password", password); 
$jsd('/BugFlow/src/login.htmlx',63,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.setAction("/ChackUser.jsp"); 
$jsd('/BugFlow/src/login.htmlx',64,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.submit(function (result) { 
$jsd('/BugFlow/src/login.htmlx',65,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); return result; 
}, function (errorCode, errorMsg) { 
$jsd('/BugFlow/src/login.htmlx',67,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("ajax Error : " + errorCode + " " + errorMsg); 
}); 
} 
