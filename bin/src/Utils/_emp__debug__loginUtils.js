...
$jsd('/flows/src/Utils/loginUtils.htmlx',9,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});var pref = new $M.Preferences(); 
$jsd('/flows/src/Utils/loginUtils.htmlx',10,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); pref.open("myPref"); 
$jsd('/flows/src/Utils/loginUtils.htmlx',12,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function checkUser(userid, password) { 
$jsd('/flows/src/Utils/loginUtils.htmlx',13,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var ajax = new $M.Ajax(); 
$jsd('/flows/src/Utils/loginUtils.htmlx',14,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("userid", userid); 
$jsd('/flows/src/Utils/loginUtils.htmlx',15,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("password", password); 
$jsd('/flows/src/Utils/loginUtils.htmlx',16,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.setAction("/CheckUser.jsp"); 
$jsd('/flows/src/Utils/loginUtils.htmlx',17,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.submit(function (result) { 
$jsd('/flows/src/Utils/loginUtils.htmlx',18,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var user = result.replace(/s/g, ""); 
$jsd('/flows/src/Utils/loginUtils.htmlx',19,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); user = user.replace(/[\r\n]/g, ""); 
$jsd('/flows/src/Utils/loginUtils.htmlx',20,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("返回值是否带空格", user); 
if($jsd('/flows/src/Utils/loginUtils.htmlx',21,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);})||true) if (user == "true") { 
$jsd('/flows/src/Utils/loginUtils.htmlx',22,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); $M.page.goTo({"url":"/choosePage.html", "params":{userid:userid}, "isDestroySelf":true, }); 
} else { 
$jsd('/flows/src/Utils/loginUtils.htmlx',30,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); $M.page.goTo({"url":"/login.html", "isDestroySelf":true, }); 
} 
}, function (errorCode, errorMsg) { 
$jsd('/flows/src/Utils/loginUtils.htmlx',36,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("ajax Error : " + errorCode + " " + errorMsg); 
}); 
} 
