...
$jsd('/flows/src/Utils/queryUtils.htmlx',10,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});function queryData(userid) { 
$jsd('/flows/src/Utils/queryUtils.htmlx',11,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var ajax = new $M.Ajax(); 
$jsd('/flows/src/Utils/queryUtils.htmlx',12,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.add("userid", userid); 
$jsd('/flows/src/Utils/queryUtils.htmlx',13,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("00000", userid); 
$jsd('/flows/src/Utils/queryUtils.htmlx',15,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.setAction("/queryPro.jsp"); 
$jsd('/flows/src/Utils/queryUtils.htmlx',16,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); ajax.submit(function (result) { 
$jsd('/flows/src/Utils/queryUtils.htmlx',17,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); return result; 
