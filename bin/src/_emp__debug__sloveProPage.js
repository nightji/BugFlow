...
Emp.page.setId('_body_1463926542');
var _div_727468585 = new Emp.Panel({"id":"_div_727468585","height":"100%","backgroundColor":"#eaeaea","layout":"VBox","width":"100%"});
var nav = new Emp.Panel({"id":"nav","height":"52","width":"100%"});
var _div_1193335007 = new Emp.Panel({"id":"_div_1193335007","height":"100%","backgroundColor":"#474747","vAlign":"middle","hAlign":"center","width":"100%"});
var _input_718526134 = new Emp.Label({"id":"_input_718526134","color":"#ffffff","value":"提交问题","fontSize":"25"});
_div_1193335007.add(_input_718526134);
nav.add(_div_1193335007);
_div_727468585.add(nav);
var _div_836273680 = new Emp.Panel({"id":"_div_836273680","marginTop":"25"});
var _input_321147590 = new Emp.Label({"id":"_input_321147590","value":"问   题   类  型:","paddingLeft":"20"});
_div_836273680.add(_input_321147590);
var select = new Emp.Select({"id":"select","marginLeft":"50","width":"150","marginRight":"20","name":"proType","value":"1",items:[ {"id":"_option_1117545772","text":"产品级","value":"1"}, {"id":"_option_2142388022","text":"项目级","value":"2"}]});
_div_836273680.add(select);
_div_727468585.add(_div_836273680);
var _div_1628421771 = new Emp.Panel({"id":"_div_1628421771","marginTop":"25"});
var _input_1978943920 = new Emp.Label({"id":"_input_1978943920","value":"问题需求类型:","paddingLeft":"20"});
_div_1628421771.add(_input_1978943920);
var select2 = new Emp.Select({"id":"select2","marginLeft":"50","width":"150","marginRight":"20","name":"reqType","value":"1",items:[ {"id":"_option_541184805","text":" BUG","value":"1"}, {"id":"_option_1099772590","text":" 新需求","value":"2"}, {"id":"_option_486170401","text":"拓展需求","value":"3"}]});
_div_1628421771.add(select2);
_div_727468585.add(_div_1628421771);
var _div_447140836 = new Emp.Panel({"id":"_div_447140836","marginTop":"25"});
var _input_1050749799 = new Emp.Label({"id":"_input_1050749799","marginTop":"10","value":"问   题   主  题:","paddingLeft":"20"});
_div_447140836.add(_input_1050749799);
var textarea = new Emp.TextArea({"id":"textarea","marginLeft":"50","width":"150","name":"proTheme"});
_div_447140836.add(textarea);
_div_727468585.add(_div_447140836);
var _div_971385263 = new Emp.Panel({"id":"_div_971385263","marginTop":"25"});
var _input_901430747 = new Emp.Label({"id":"_input_901430747","marginTop":"10","value":"问   题   描  述:","paddingLeft":"20"});
_div_971385263.add(_input_901430747);
var textarea = new Emp.TextArea({"id":"textarea","marginLeft":"50","width":"150","name":"proDescript"});
_div_971385263.add(textarea);
_div_727468585.add(_div_971385263);
var _div_1341365721 = new Emp.Panel({"id":"_div_1341365721","marginTop":"25"});
var _input_50346641 = new Emp.Label({"id":"_input_50346641","marginTop":"10","value":"客                户:","paddingLeft":"20"});
_div_1341365721.add(_input_50346641);
var text = new Emp.TextArea({"id":"text","paddingTop":"5","marginLeft":"50","width":"150","name":"cusName"});
_div_1341365721.add(text);
_div_727468585.add(_div_1341365721);
var _div_1712785814 = new Emp.Panel({"id":"_div_1712785814","marginTop":"25"});
var _input_1920371510 = new Emp.Label({"id":"_input_1920371510","marginTop":"10","value":"预 计 工 作 量:","paddingLeft":"20"});
_div_1712785814.add(_input_1920371510);
var text = new Emp.TextArea({"id":"text","paddingTop":"5","marginLeft":"50","width":"150","name":"effExpected"});
_div_1712785814.add(text);
_div_727468585.add(_div_1712785814);
var _div_1800777250 = new Emp.Panel({"id":"_div_1800777250","marginTop":"50"});
var _input_1176203579 = new Emp.Button({"id":"_input_1176203579","color":"#0000FF","marginLeft":"90","value":"提交"});
_input_1176203579.addEvent('onClick',login);
_div_1800777250.add(_input_1176203579);
var _input_866581618 = new Emp.Button({"id":"_input_866581618","color":"#FF0000","marginLeft":"40","value":"取消"});
_input_866581618.addEvent('onClick',login);
_div_1800777250.add(_input_866581618);
_div_727468585.add(_div_1800777250);
Emp.page.add(_div_727468585);
...
$jsd('/flow/src/sloveProPage.htmlx',57,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});function buttonClick() { 
$jsd('/flow/src/sloveProPage.htmlx',58,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); dialog.show(); 
} 
$jsd('/flow/src/sloveProPage.htmlx',61,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); function login() { 
$jsd('/flow/src/sloveProPage.htmlx',62,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); alert("提交数据中......"); 
$jsd('/flow/src/sloveProPage.htmlx',63,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var form = new $M.Form(); 
$jsd('/flow/src/sloveProPage.htmlx',64,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); form.setAction("/submitProblem.jsp"); 
$jsd('/flow/src/sloveProPage.htmlx',65,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); form.submit(function (result) { 
}, function (errorCode, errorMsg) { 
$jsd('/flow/src/sloveProPage.htmlx',68,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); log("ajax Error : " + errorCode + " " + errorMsg); 
}); 
} 
